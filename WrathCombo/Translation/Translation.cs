...
namespace WrathCombo.Translation
{
    internal class Translation
    {
        ...
        private static Dictionary<string, string> TransDict = new Dictionary<string, string>()
        {
            ...
            {"Replaces Heavy Swing with a full one-button single target rotation.\nThis is the ideal option for newcomers to the job.","用一键单体连体代替【重斩】，这个对萌新很友好。"},
            ...
            {"Replaces Heavy Swing with a full one-button single target rotation.\nThese features are ideal if you want to customize the rotation.","用一键单体连体代替【重斩】，想自定义循环的用这个。"},
            ...
            {"Adds Twinfang and Twinblood to the rotation.","把【双牙连术】和【双牙乱术】也放进来"},
            ...
            {"Include Twin Combo Actions","把双牙术的连击也整合了"},
            {"Adds Twinfang and Twinblood to the button.","把【双牙连术】和【双牙乱术】也放进来"},
            {"Legacy Buttons","祖灵之蛇"},
            ...
            {"Buffs Option","开Buff"},
            {"Adds buffs onto the Advanced Bard feature.","在单体循环中开Buff"},
