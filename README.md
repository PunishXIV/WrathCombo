...
| `/wrath burst`                         | Toggles all Burst-related Features in your Advanced Mode (and only Advanced Mode) Combo.<br>(is functionally the same as using a [Burst Holding Macro]())                      |
